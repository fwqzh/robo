function positionC = anklePositionC(d3, stepNumber, x1, z1, stairLength, stairHeight, xM ...%第一个台阶边沿stairnumber=1
    , zM, dNQ, dQR, dNK, dMK)
    xR = x1 + stepNumber * stairLength - d3 * stairHeight / sqrt(stairHeight ^ 2 + stairLength ^ 2);
    zR = z1 + stepNumber * stairHeight + d3 * stairLength / sqrt(stairHeight ^ 2 + stairLength ^ 2);
